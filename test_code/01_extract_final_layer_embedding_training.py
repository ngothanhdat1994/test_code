...
metadata_csv_dir = "./metadata_training.csv"

# Input directory
input_directory = "./../../07_Dat_cough/for_dat/Second_DiCOVA_Challenge_Dev_Data_Release/AUDIO/cough"
...
with open(os.path.join("trill_final_layer_embeddings_training"+".csv"), "a") as text_file:
